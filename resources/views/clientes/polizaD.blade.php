...
<table style="font-size: 14px;">
  ...
  <tr>
   ...
   <tr>
    ...
    <td style="position: absolute;left: 33%;top: 57.5%;"><b>@if($pagos->numeropagos >1)4 pagos de $870 @else 1 pago de $3,480 @endif</b></td>
  </tr>
  <tr>
    <td style="position: absolute;left: 14%;top: 88%;"><b>{{$contrato->plazo}} AÑOS</b></td>
