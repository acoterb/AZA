<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @can('cobradores_view')
                    <x-jet-responsive-nav-link href="{{ route('cobradores.index') }}" :active="request()->routeIs('cobradores.index')">
                        {{ __('Cobradores') }}
                    </x-jet-responsive-nav-link>
                    @endcan
                    @can('vendedor_view')
                    <x-jet-responsive-nav-link href="{{ route('vendedores.index') }}" :active="request()->routeIs('vendedores.index')">
                        {{ __('Vendedores') }}
                    </x-jet-responsive-nav-link>
                    @endcan
                    @can('clientes_view')
                    <x-jet-responsive-nav-link href="{{ route('cliente.index') }}" :active="request()->routeIs('cliente.index')">
                        {{ __('Clientes') }}
                    </x-jet-responsive-nav-link>
                    @endcan
                    @can('usuarios_view')
                    <x-jet-responsive-nav-link href="{{ route('usuarios.index') }}" :active="request()->routeIs('usuarios.index')">
                        ...
                        @endcan
                    @can('choques_view')
                        <x-jet-responsive-nav-link href="{{ route('choques.index') }}" :active="request()->routeIs('choques.index')">
                            {{ __('Choques') }}
                        </x-jet-responsive-nav-link>
                    @endcan
                    @can('pagos_view')
                        <x-jet-responsive-nav-link href="{{ route('pagos.index') }}" :active="request()->routeIs('pagos.index')">
                            {{ __('Pagos') }}
                        </x-jet-responsive-nav-link>
                    @endcan
                    @can('usuarios_view')
                        <x-jet-responsive-nav-link href="{{ route('reportes.index') }}" :active="request()->routeIs('reportes.index')">
                            {{ __('Reportes') }}
                        </x-jet-responsive-nav-link>
                    @endcan
